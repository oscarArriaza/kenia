...
(
    ...
    function()
    {
        ...
        let respuestasCorrectas=[31,4,8,40,62,37,72,72,24];
        ...
        function estaFuncionSiEslaQueMueveAlPersonaje()
        {
            ...
            if(!seDetectoColisionConMorani)
            {
                ...
                if(seDetectoColisionConMorani)
                {
                    ...
                    laiaBloqueada=true;
                    dialogo4.showModal();
                    let linea13=document.getElementById("linea13");
                    linea13.play();
                    setTimeout
                    (
                        () =>
                        {
                            let linea14=document.getElementById("linea14");
                            linea14.play();
            ...
            if(!seDetectoColisionConKiano)
            {
                ...
                if(seDetectoColisionConKiano)
                {
                    ...
                    laiaBloqueada=true;
                    dialogo5.showModal();
                    let linea16=document.getElementById("linea16");
                    linea16.play();
                    setTimeout
                    (
                        ()=>
                        {
                            let linea17=document.getElementById("linea17");
                            linea17.play();
        ...
        function conversacionConMatu(emisor,parrafo)
        {
            ...
            if(numeroDeLineaDeDialogo2===3)
            {
                ...
                (
                    () =>
                    {
                        let linea10=document.getElementById("linea10");
                        linea10.play();
            ...
            else if(numeroDeLineaDeDialogo2===4)
            {
                ...
                (
                    () =>
                    {
                        let linea11=document.getElementById("linea11");
                        linea11.play();
            ...
            if(campoRespuestaPasoLaValidacion)
            {
                ...
                if(valorRadioButtonSeleccionado===respuestasCorrectas[numeroDeGraficoAleatorio])
                {
                    ...
                    else if(graficosUsados.length===3)
                    {
                        ...
                        retratoLaia2.src="./media/imagenes/imagenesPersonajePrincipal/retratoLaia.png";
                        let linea12=document.getElementById("linea12");
                        linea12.play();
                        dialogo2.showModal();
                        setTimeout
                        (
                    ...
                    else if(graficosUsados.length===5)
                    {
                        ...
                        retratoLaia3.src="./media/imagenes/imagenesPersonajePrincipal/retratoLaiaIzquierda.png";
                        dialogo4.showModal();
                        let linea15=document.getElementById("linea15");
                        linea15.play();
                        setTimeout
                        (
                            () =>
                    ...
                    else if(graficosUsados.length===6)
                    {
                        ...
                        retratoLaia4.src="./media/imagenes/imagenesPersonajePrincipal/retratoLaia.png";
                        dialogo5.showModal();
                        let linea18=document.getElementById("linea18");
                        linea18.play();
                        setTimeout
                        (
                            ()=>
